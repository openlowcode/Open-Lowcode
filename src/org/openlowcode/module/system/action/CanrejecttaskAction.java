...
import org.openlowcode.module.system.action.generated.AbsCanrejecttaskAction;
...
/**
 * this action checks if the current user can reject the task
 * 
 * @author <a href="https://openlowcode.com/" rel="nofollow">Open Lowcode
 *         SAS</a>
 *
 */
public class CanrejecttaskAction extends AbsCanrejecttaskAction {
	/**
	 * Creates the action
	 * 
	 * @param parent parent module
	 */
	public CanrejecttaskAction(SModule parent) {
		super(parent);
	}
	...
	public ActionOutputData executeActionLogic(DataObjectId<Task> taskid,Function<TableAlias,QueryFilter> datafilter)  {
		...
		return new ActionOutputData(subjectcasted.canrejecttask(taskid, userid));
	}

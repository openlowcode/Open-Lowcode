...
import org.openlowcode.module.system.action.generated.AbsLaunchaddlogsAction;
...
/**
 * a simple action launching the add logs page
 * 
 * @author <a href="https://openlowcode.com/" rel="nofollow">Open Lowcode
 *         SAS</a>
 *
 */
public class LaunchaddlogsAction
		extends
		AbsLaunchaddlogsAction {
	/**
	 * Creates the action
	 * 
	 * @param parent parent module
	 */
	public LaunchaddlogsAction(SModule parent) {
		super(parent);

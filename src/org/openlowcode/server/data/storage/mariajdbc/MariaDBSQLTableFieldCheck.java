 ...
 *
 */
public class MariaDBSQLTableFieldCheck
		extends StandardJDBCTableFieldCheck {
	 ...
	 */
	public MariaDBSQLTableFieldCheck(BaseJDBCStorage.DatabaseColumnType columntype) {
		super(columntype);
	}

...
/**
 * A loader allowing to create links to master to right objects using the right object
 ...
 */
public class LeftforlinktomasterFlatFileLoader<E extends DataObject<E> & NumberedInterface<E> & UniqueidentifiedInterface<E>, F extends DataObject<F> & LinkobjecttomasterInterface<F, E, G>, G extends DataObject<G> & NumberedInterface<G> & VersionedInterface<G>>
...
* @param linktomasterpropertydef     definition of the link to master object property
...
*/
public LeftforlinktomasterFlatFileLoader(DataObjectDefinition<E> leftobjectdefinition,
	DataObjectDefinition<F> linkobjectdefinition, DataObjectDefinition<G> rightobjectdefinition,
	LinkobjecttomasterDefinition<F, E, G> linktomasterpropertydef, NumberedDefinition<G> rightobjectnumberproperty,
...
F[] existinglinks = LinkobjecttomasterQueryHelper.get().getalllinksfromleftid(leftid, null, linkobjectdefinition,
		leftobjectdefinition, rightobjectdefinition, linktomasterpropertydef);
			...
			if (rightobject == null)
				if (this.createrightifnotexists) {
					...
					for (int j = 0; j < linktomasterpropertydef.getConstraintOnLinkToMasterNumber(); j++) {
						ConstraintOnLinkToMaster<E, G> constraint = linktomasterpropertydef
...
TwoDataObjects<F, G>[] links = LinkobjecttomasterQueryHelper.get().getlinksandrightobject(currentobject.getId(), null,

 ...
 *
 */
public class IteratedlinktomasterQueryHelper {
	private static IteratedlinktomasterQueryHelper singleton = new IteratedlinktomasterQueryHelper();
	 ...
	 */
	public static IteratedlinktomasterQueryHelper get() {
		return singleton;
	}
	...
	public <
			...
			G extends DataObject<G> & VersionedInterface<G>> QueryCondition getIterationQueryCondition(
					TableAlias alias,
					Integer iteration,
					DataObjectDefinition<E> parentdefinition,
					IteratedlinktomasterDefinition<E, F, G> iteratedlinkdefinition) {
	...
	public <
			E extends DataObject<E> & LinkobjecttomasterInterface<E, F, G> & IteratedlinktomasterInterface<E, F, G>,
			F extends DataObject<F> & IteratedInterface<F>,
			G extends DataObject<G> & VersionedInterface<G>> E[] getalllinksfromleftiteration(
		...
		QueryCondition extendedcondition = parentobjectdefinition.extendquery(aliaslist, alias,
				LinkobjecttomasterQueryHelper.get().getLeftidQueryCondition(alias, leftid, parentobjectdefinition,

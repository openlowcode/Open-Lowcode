...
/**
 * Query Helper for Link Object To Master property
 * 
...
public class LinkobjecttomasterQueryHelper {
	...
	private static LinkobjecttomasterQueryHelper singleton = new LinkobjecttomasterQueryHelper();

	public static LinkobjecttomasterQueryHelper get() {
		return singleton;
	}
	...
	public <
			...
			G extends DataObject<G> & VersionedInterface<G>> StoredFieldSchema<String> getLeftIdFieldSchema(
					LinkobjecttomasterDefinition<E, F, G> definition) {
	...
	public <
			E extends DataObject<E> & LinkobjecttomasterInterface<E, F, G>,
			F extends DataObject<F> & UniqueidentifiedInterface<F>,
			G extends DataObject<G> & VersionedInterface<G>> StoredFieldSchema<String> getRightMasterIdFieldSchema(
					LinkobjecttomasterDefinition<E, F, G> definition) {
		return (StoredFieldSchema<String>) definition.getDefinition().lookupOnName("RGMSID");
	}
	...
	public <
			E extends DataObject<E> & LinkobjecttomasterInterface<E, F, G>,
			F extends DataObject<F> & UniqueidentifiedInterface<F>,
			G extends DataObject<G> & VersionedInterface<G>> QueryCondition getLeftidQueryCondition(
					TableAlias alias,
		...
		LinkobjecttomasterDefinition<E, F, G> definition = new LinkobjecttomasterDefinition<E, F, G>(
				parentobjectdefinition, leftobjectdefinition, rightobjectdefinition, false);
		@SuppressWarnings("unchecked")
	...
	public <
			E extends DataObject<E> & LinkobjecttomasterInterface<E, F, G>,
			F extends DataObject<F> & UniqueidentifiedInterface<F>,
			G extends DataObject<G> & VersionedInterface<G>> QueryCondition getRightMasteridQueryCondition(
					TableAlias alias,
					DataObjectMasterId<G> idvalue,
					DataObjectDefinition<E> parentobjectdefinition,
					DataObjectDefinition<F> leftobjectdefinition,
					DataObjectDefinition<G> rightobjectdefinition) {
		LinkobjecttomasterDefinition<E, F, G> definition = new LinkobjecttomasterDefinition<E, F, G>(
				parentobjectdefinition, leftobjectdefinition, rightobjectdefinition, false);
		@SuppressWarnings("unchecked")
		StoredFieldSchema<String> msid = (StoredFieldSchema<String>) definition.getDefinition().lookupOnName("RGMSID");
		if (alias == null)
			return new SimpleQueryCondition<String>(null, msid, new QueryOperatorEqual<String>(),
					(idvalue == null ? BLANK_ID : idvalue.getId()));
		return new SimpleQueryCondition<String>(alias, msid, new QueryOperatorEqual<String>(),
				(idvalue == null ? BLANK_ID : idvalue.getId()));
	}
	...
	public <
			E extends DataObject<E> & LinkobjecttomasterInterface<E, F, G>,
			F extends DataObject<F> & UniqueidentifiedInterface<F>,
			G extends DataObject<G> & VersionedInterface<G>> E[] getalllinksfromleftid(
					DataObjectId<F> leftid,
					QueryFilter additionalcondition,
					DataObjectDefinition<E> parentobjectdefinition,
					DataObjectDefinition<F> leftobjectdefinition,
					DataObjectDefinition<G> rightobjectdefinition,
					LinkobjecttomasterDefinition<E, F, G> propertydefinition) {
	...
	/**
	 * gets all links from the provided series of right object master ids
	 * 
	 * @param rightmsid                a series of right objet master ids
	 * @param additionalcondition    additional filter condition
	 * @param parentobjectdefinition definition of the parent object
	 * @param leftobjectdefinition   definition of the left object for the link
	 * @param rightobjectdefinition  definition of the right object for the link
	...
	public <
			E extends DataObject<E> & LinkobjecttomasterInterface<E, F, G>,
			F extends DataObject<F> & UniqueidentifiedInterface<F>,
			G extends DataObject<G> & VersionedInterface<G>> E[] getalllinksfromrightmsid(
					DataObjectMasterId<G>[] rightmsid,
					QueryFilter additionalcondition,
					DataObjectDefinition<E> parentobjectdefinition,
					DataObjectDefinition<F> leftobjectdefinition,
					DataObjectDefinition<G> rightobjectdefinition,
		...
		// work by batches to ensure query is not too long
		for (int i = 0; i < (rightmsid.length / BATCH_QUERY_SIZE) + 1; i++) {
			NamedList<TableAlias> aliaslist = new NamedList<TableAlias>();
			TableAlias alias = parentobjectdefinition.getAlias("SINGLEOBJECT");
			aliaslist.add(alias);
			if (additionalcondition != null)
			...
			OrQueryCondition uniqueidcondition = new OrQueryCondition();
			int min = i * BATCH_QUERY_SIZE;
			if (min < rightmsid.length) {
				for (int j = min; j < min + BATCH_QUERY_SIZE; j++) {
					QueryCondition thisuniqueidcondition = null;
					if (j < rightmsid.length) {
						thisuniqueidcondition = getRightMasteridQueryCondition(alias, rightmsid[j], parentobjectdefinition,
								leftobjectdefinition, rightobjectdefinition);
					} else {
						// all queries will have batch size conditions. If not enough id, a blank id is
						// used
						thisuniqueidcondition = getRightMasteridQueryCondition(alias, null, parentobjectdefinition,
								leftobjectdefinition, rightobjectdefinition);
	...
	/**
	 * gets all links from the right object master id
	 * 
	 * @param rightmasterid                a right object master id
	 * @param additionalcondition    additional filter condition
	 * @param parentobjectdefinition definition of the parent object
	 * @param leftobjectdefinition   definition of the left object for the link
	 * @param rightobjectdefinition  definition of the right object for the link
	...
	public <
			...
			F extends DataObject<F> & UniqueidentifiedInterface<F>,
			G extends DataObject<G> & VersionedInterface<G>> E[] getalllinksfromrightmsid(
					DataObjectMasterId<G> rightmasterid,
					QueryFilter additionalcondition,
					DataObjectDefinition<E> parentobjectdefinition,
					DataObjectDefinition<F> leftobjectdefinition,
					DataObjectDefinition<G> rightobjectdefinition,
		...
		QueryCondition extendedcondition = parentobjectdefinition.extendquery(aliaslist, alias,
				getRightMasteridQueryCondition(alias, rightmasterid, parentobjectdefinition, leftobjectdefinition,
	...
	public <
			E extends DataObject<E> & LinkobjecttomasterInterface<E, F, G>,
			F extends DataObject<F> & UniqueidentifiedInterface<F>,
			G extends DataObject<G> & VersionedInterface<G>> E[] getalllinksfromleftandrightid(
					DataObjectId<F> leftid,
					DataObjectMasterId<G> rightid,
					QueryFilter additionalcondition,
					DataObjectDefinition<E> parentobjectdefinition,
					DataObjectDefinition<F> leftobjectdefinition,
					DataObjectDefinition<G> rightobjectdefinition,
		...
		leftandright.addCondition(getLeftidQueryCondition(alias, leftid, parentobjectdefinition, leftobjectdefinition,
				rightobjectdefinition));
		leftandright.addCondition(getRightMasteridQueryCondition(alias, rightid, parentobjectdefinition, leftobjectdefinition,
				rightobjectdefinition));
	...
	public <
			E extends DataObject<E> & LinkobjecttomasterInterface<E, F, G>,
			F extends DataObject<F> & UniqueidentifiedInterface<F>,
			G extends DataObject<G> & VersionedInterface<G>> ThreeDataObjects<F, E, G>[] getlinksandbothobjects(
					QueryFilter additionalcondition,
					DataObjectDefinition<E> parentobjectdefinition,
					DataObjectDefinition<F> leftobjectdefinition,
					DataObjectDefinition<G> rightobjectdefinition,
		...
		if (additionalcondition != null)
			if (additionalcondition.getAliases() != null)
				for (int i = 0; i < additionalcondition.getAliases().length; i++)
					aliaslist.add(additionalcondition.getAliases()[i]);
		// LinkobjecttomasterDefinition definition = new
		// LinkobjecttomasterDefinition(parentobjectdefinition, leftobjectdefinition,
		// rightobjectdefinition);
		...
		twojoinscondition.addCondition(VersionedQueryHelper.getLatestVersionQueryCondition(rightobjectalias, rightobjectdefinition));	
		if (additionalcondition != null)
	...
	public <
			...
			G extends DataObject<G> & VersionedInterface<G>> G[] getpotentialrightobject(
					DataObjectId<E> leftobjectid,
					QueryFilter additionalcondition,
					DataObjectDefinition<F> linkobjectdefinition,
					DataObjectDefinition<E> leftobjectdefinition,
					DataObjectDefinition<G> rightobjectdefinition,
					LinkobjecttomasterDefinition<F, E, G> propertydefinition) {
		...
		for (int i = 0; i < propertydefinition.getConstraintOnLinkToMasterNumber(); i++) {
			ConstraintOnLinkToMaster<E, G> constraintonlinkobject = propertydefinition.getConstraintOnLinkToMaster(i);
		...
		G[] result = StoredobjectQueryHelper.get().getallactive(
				...
				rightobjectdefinition, propertydefinition.getRightversioneddefinition()
						.getDependentDefinitionUniqueidentified().getDependentDefinitionStoredobject());
	...
	public <
			E extends DataObject<E> & UniqueidentifiedInterface<E>,
			F extends DataObject<F> & LinkobjecttomasterInterface<F, E, G>,
			G extends DataObject<G> & VersionedInterface<G>> E[] getpotentialleftobject(
					DataObjectMasterId<G> rightobjectid,
					QueryFilter additionalcondition,
					DataObjectDefinition<F> linkobjectdefinition,
					DataObjectDefinition<E> leftobjectdefinition,
					DataObjectDefinition<G> rightobjectdefinition,
	...
	public <
			E extends DataObject<E> & UniqueidentifiedInterface<E>,
			F extends DataObject<F> & LinkobjecttomasterInterface<F, E, G>,
			G extends DataObject<G> & VersionedInterface<G>> E[] getleftobjectsfromright(
					DataObjectMasterId<G> rightid,
					QueryFilter additionalcondition,
					DataObjectDefinition<F> linkobjectdefinition,
					DataObjectDefinition<E> leftobjectdefinition,
		...
		LinkobjecttomasterDefinition<F, E, G> definition = new LinkobjecttomasterDefinition<F, E, G>(
				linkobjectdefinition, leftobjectdefinition, rightobjectdefinition, false);
		QueryCondition rightidcondition = linkobjectdefinition.extendquery(aliaslist, linkalias,
				getRightMasteridQueryCondition(linkalias, rightid, linkobjectdefinition, leftobjectdefinition,
						rightobjectdefinition));
	...
	public <
			E extends DataObject<E> & UniqueidentifiedInterface<E>,
			F extends DataObject<F> & LinkobjecttomasterInterface<F, E, G>,
			G extends DataObject<G> & VersionedInterface<G>> TwoDataObjects<F, G>[] getlinksandrightobject(
					DataObjectId<E>[] leftid,
					QueryFilter additionalcondition,
					DataObjectDefinition<F> linkobjectdefinition,
					DataObjectDefinition<E> leftobjectdefinition,
					DataObjectDefinition<G> rightobjectdefinition,
		...
		for (int i = 0; i < (leftid.length / BATCH_QUERY_SIZE) + 1; i++) {
			...
			if (min < leftid.length) {
				...
				QueryCondition extendedconditionforright = rightobjectdefinition.extendquery(aliaslist,
						rightobjectalias, extendedcondition);

				QueryCondition rightuniversalcondition = rightobjectdefinition.getUniversalQueryCondition(null,
						LINKSANDBOTHOBJECTS_RIGHTOBJECTALIAS);
				if (rightuniversalcondition != null)
					extendedconditionforright = new AndQueryCondition(extendedconditionforright,
							rightuniversalcondition);
	...
	public <
		...
		if (additionalcondition != null)
			if (additionalcondition.getAliases() != null)
				for (int i = 0; i < additionalcondition.getAliases().length; i++)
					aliaslist.add(additionalcondition.getAliases()[i]);
		// LinkobjecttomasterDefinition<F,E,G> definition = new
		// LinkobjecttomasterDefinition<F,E,G>(linkobjectdefinition,
	...
	public <
			E extends DataObject<E> & UniqueidentifiedInterface<E>,
			F extends DataObject<F> & LinkobjecttomasterInterface<F, E, G>,
			G extends DataObject<G> & VersionedInterface<G>> TwoDataObjects<E, F>[] getlinksandleftobject(
					DataObjectMasterId<G>[] rightid,
					QueryFilter additionalcondition,
					DataObjectDefinition<F> linkobjectdefinition,
					DataObjectDefinition<E> leftobjectdefinition,
		...
		for (int i = 0; i < (rightid.length / BATCH_QUERY_SIZE) + 1; i++) {
			...
			if (min < rightid.length) {
				for (int j = min; j < min + BATCH_QUERY_SIZE; j++) {
					QueryCondition thisuniqueidcondition = null;
					if (j < rightid.length) {
						thisuniqueidcondition = getRightMasteridQueryCondition(linkalias, rightid[j], linkobjectdefinition,
								leftobjectdefinition, rightobjectdefinition);
					} else {
						// all queries will have batch size conditions. If not enough id, a blank id is
						// used
				...
				joinquerycondition.addCondition(uniqueidcondition);
				joinquerycondition.addCondition(
						new JoinQueryCondition<String>(linkalias, this.getLeftIdFieldSchema(propertyDefinition),
								leftobjectalias, leftobjectdefinition.getTableschema().lookupFieldByName("ID"),
								new QueryOperatorEqual<String>()));
				if (additionalcondition != null)
					if (additionalcondition.getCondition() != null)
	...
	public <
		...
		// leftobjectdefinition,
		// rightobjectdefinition);
		QueryCondition idcondition = linkobjectdefinition.extendquery(aliaslist, linkalias, getRightMasteridQueryCondition(

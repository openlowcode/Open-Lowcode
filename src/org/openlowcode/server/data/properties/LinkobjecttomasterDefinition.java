 ...
 *         SAS</a>
 *
 * @param <E> current link object
 * @param <F> left object for link (linked through ID)
 * @param <G> right object for link (linked through master id
 * @since 1.9
 */
public class LinkobjecttomasterDefinition<
	...
	private StringStoredField rightmasterid;
	private ArrayList<ConstraintOnLinkToMaster<F, G>> constraintsonlinkobject;
	...
	private VersionedDefinition<G> rightversionedefinition;
	 ...
	 * object into a link between a left data object and a right data object (right
	 * data object linked through master)
	 * 
	 ...
	 *                                    client before having been persisted. This
	 *                                    may be a security risk that the data is
	 *                                    tampered on the client side
	 */
	public LinkobjecttomasterDefinition(
	...
	/**
	 * creates the definition of the link object to master property that turns this
	 * data object into a link between a left data object and a right data object
	 * 
	 * @param parentobject          parent object definition
	 * @param leftobjectdefinition  definition of the left object for link
	 * @param rightobjectdefinition definition of the right object for link
	...
	public LinkobjecttomasterDefinition(
			...
			DataObjectDefinition<G> rightobjectdefinition,
			boolean makesidmodifiable) {
		super(parentobject, "LINKOBJECTTOMASTER");
		...
		rightmasterid = new StringStoredField("RGMSID", null, 200);
	 ...
	 */
	public void setConstraintOnLinkToMaster(ConstraintOnLinkToMaster<F, G> constraintonlinkobject) {
	 ...
	 */
	public ConstraintOnLinkToMaster<F, G> getConstraintOnLinkToMaster(int index) {
	 ...
	 */
	public int getConstraintOnLinkToMasterNumber() {
	 ...
	 *                                        right object
	 */
	public void setGenericsRightobjectforlinkProperty(VersionedDefinition<G> rightversionedefinition) {
		this.rightversionedefinition = rightversionedefinition;
	 ...
	 */
	public VersionedDefinition<G> getRightversioneddefinition() {
		return this.rightversionedefinition;
	}
	...
	public ConstraintOnLinkToMaster<F, G>[] getAllConstraints() {
		return this.constraintsonlinkobject.toArray(new ConstraintOnLinkToMaster[0]);
	}
...
// get state property for left object
		...
		JoinQueryConditionDefinition<String> rightjoincondition = rightobjectdefinition.generateJoinQueryDefinition(
				this.parentobject.getTableschema(), rightmasterid, "VERSIONED", "MASTERID", this.getName() + "_RIGHT",
				new QueryOperatorEqual<String>(), (a) -> (VersionedQueryHelper
						.getLatestVersionQueryCondition(rightobjectdefinition.getAlias(a), rightobjectdefinition)));
...
// get named property for right object
	...
	public FieldSchemaForDisplay<E>[] setFieldSchemaToDisplay() {
		...
		returnvalue[1] = new FieldSchemaForDisplay<E>("Right id",
				"the technical id generated by the system for the right object of the part", rightmasterid, false, true,
				!makesidmodifiable, -200, 16, this.parentobject);
	...
	public DataObjectElement initiateFieldInstance(DataObjectPayload parentpayload) {
		return new Linkobjecttomaster<E, F, G>(this, parentpayload, leftobjectdefinition, rightobjectdefinition);
	}

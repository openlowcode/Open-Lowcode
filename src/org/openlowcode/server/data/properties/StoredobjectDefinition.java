...
/**
 * Definition of the StoredObject property
 * 
 ...
 */
public class StoredobjectDefinition<E extends DataObject<E>> extends DataObjectPropertyDefinition<E> {

	/**
	 * creates a new StoredobjectDefinition for the object
	 * @param parentobject parent object for the property
	 */
	public StoredobjectDefinition(DataObjectDefinition<E> parentobject) {
		super(parentobject, "STOREDOBJECT");

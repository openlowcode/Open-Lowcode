 ...
 */
public class RightforlinkDefinition<E extends DataObject<E> & UniqueidentifiedInterface<E>, F extends DataObject<F> & LinkobjectInterface<F, G, E>, G extends DataObject<G> & UniqueidentifiedInterface<G>>
		extends DataObjectPropertyDefinition<E> {

	@SuppressWarnings("unused")
	private DataObjectDefinition<F> linkobjectdefinition;
	private LinkobjectDefinition<F, G, E> linkobjectpropertydefinition;
	@SuppressWarnings("unused")
	 ...
	 */
	public RightforlinkDefinition(DataObjectDefinition<E> parentobject, String name,
			DataObjectDefinition<F> linkobjectdefinition, DataObjectDefinition<G> leftobjectforlinkdefinition) {
	...
	public DataObjectElement initiateFieldInstance(DataObjectPayload parentpayload) {
		...
		return new Rightforlink<E, F, G>(this, parentpayload);
	}
	 ...
	 */
	public void setGenericsLinkobjectProperty(LinkobjectDefinition<F, G, E> linkobjectpropertydefinition) {
	 ...
	 */
	public LinkobjectDefinition<F, G, E> getLinkObjectPropertyDefinition() {
	 ...
	 */
	public void setGenericsLeftobjectforlinkProperty(

...
/**
*
* A constraint on link to master object restrains the right objects that can be linked to
* a left object.
* 
...
*/
public abstract class ConstraintOnLinkToMaster<E extends DataObject<E>, F extends DataObject<F>> {

	/**
	 * checks if it is authorized to set a link between two objects with their id
	 * 
	 * @param leftobject  id of the left object
	 * @param rightobject master id of the right object
	 * @return true if link creation is authorized, false if link creation is not
	 *         authorized
	 */
	public abstract boolean checklinkvalid(DataObjectId<E> leftobject, DataObjectMasterId<F> rightobject);
	 ...
	 * 
	 * @param maintablealias alias to generate the condition for
	 * @param rightobjectmasterid  master id of the right object
	 * @return a query condition that will return only valid left objects for link
	 *         creation
	 */
	public abstract QueryCondition generateReverseQueryFilter(TableAlias maintablealias, DataObjectMasterId<F> rightobjectmasterid);

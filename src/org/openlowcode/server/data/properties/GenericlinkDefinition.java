...
import org.openlowcode.tools.file.StringFormatter;
...
public class GenericlinkDefinition<E extends DataObject<E>> extends DataObjectPropertyDefinition<E> {
	 ...
	 *                     definition
	 */
	public GenericlinkDefinition(DataObjectDefinition<E> parentobject, String name) {
	...
	public org.openlowcode.server.data.DataObjectPropertyDefinition.FieldSchemaForDisplay<E>[] setFieldSchemaToDisplay() {
		...
		returnvalue[0] = new FieldSchemaForDisplay<E>(StringFormatter.formatForJavaClass(this.getName()) + " Object Id",

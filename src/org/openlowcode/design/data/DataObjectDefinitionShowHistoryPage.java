...
public class DataObjectDefinitionShowHistoryPage
	...
	public void generateToFile(SourceGenerator sg, Module module) throws IOException {
		...
		sg.wl("import gallium.server.graphic.widget.SObjectArray;");
		sg.wl("import gallium.server.graphic.widget.SObjectBand;");
		...
		sg.wl("			DataObjectId<" + objectclass + "> " + objectvariable + "id) throws GalliumException {");
		...
		sg.wl("");
		sg.wl("	@Override");
		sg.wl("	protected SPageNode getContent() throws GalliumException {");

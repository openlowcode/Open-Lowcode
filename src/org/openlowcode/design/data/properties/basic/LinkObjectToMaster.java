 ...
 *         SAS</a>
 *
 * @param <E> left object for link to master (must have property
 *        {@link org.openlowcode.design.data.properties.basic.UniqueIdentified}
 *        )
 * @param <F> right object for link to master (must have property
 *        {@link org.openlowcode.design.data.properties.basic.Versioned}
 *        )
 */
public class LinkObjectToMaster<E extends DataObjectDefinition, F extends DataObjectDefinition>
extends
Property<LinkObjectToMaster<E, F>> {
	...
	@Override
	public void addBusinessRule(PropertyBusinessRule<LinkObjectToMaster<E, F>> rule) {
	 ...
	 */
	public LinkObjectToMaster(E leftobjectforlink, F rightobjectforlink) {
	 ...
	 */
	public LinkObjectToMaster(E leftobjectforlink, F rightobjectforlink, String labelfromleft, String labelfromright) {
		super("LINKOBJECTTOMASTER");
	...
	public void controlAfterParentDefinition() {
		...
		this.addPropertyGenerics(
				new PropertyGenerics("RIGHTOBJECTFORLINK", rightobjectforlink, new Versioned()));
		...
		if (this.leftobjectforlink.getPropertyByName("ITERATED") != null) {
			...
			// link is created
			this.addExternalObjectProperty(parent, new IteratedLinkToMaster(this));
		}
		...
		this.addExternalObjectProperty(leftobjectforlink,
				new LeftForLinkToMaster(this.getParent(), rightobjectforlink, this, displaypriorityfromleft));
		this.addExternalObjectProperty(rightobjectforlink,
				new RightForLinkToMaster(this.getParent(), leftobjectforlink, this, displaypriorityfromright));
		...
		DataAccessMethod getlinksfromright = new DataAccessMethod("GETALLLINKSFROMRIGHTMSID",
				new ArrayArgument(new ObjectArgument("links", parent)), true);
		getlinksfromright.addInputArgument(
				new MethodArgument("rightmsid", new ObjectMasterIdArgument("rightmsid", this.rightobjectforlink)));
		...
		getlinksandleftobject.addInputArgument(
				new MethodArgument("RIGHTMSID", new ObjectMasterIdArgument("RIGHTOBJECTMSID", this.rightobjectforlink)));
		...
		getpotentialleftobjects.addInputArgument(
				new MethodArgument("rightobjectmsid", new ObjectMasterIdArgument("rightobject", this.rightobjectforlink)));
		...
		DataAccessMethod setrightobject = new DataAccessMethod("SETRIGHTOBJECTMASTER", null, false);
		...
		setrightobject.addInputArgument(
				new MethodArgument("rightobject", new ObjectMasterIdArgument("rightobject", this.rightobjectforlink)));
		this.addDataAccessMethod(setrightobject);

		StoredElement leftid = new ObjectIdStoredElement("LFID", leftobjectforlink);
		StoredElement rightmsid = new ObjectMasterIdStoredElement("RGMSID", rightobjectforlink);
		this.addElement(leftid);
		this.addElement(rightmsid);

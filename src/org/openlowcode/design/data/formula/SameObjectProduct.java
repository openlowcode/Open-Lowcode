 ...
 *         SAS</a>
 */
public class SameObjectProduct
		implements
	 ...
	 * 
	 * @param element1 the first element in the product (e.g. 5 in " 5 * 2 = 10")
	 * @param element2 the second element in the product (e.g. 2 in " 5 * 2 = 10")
	 */
	public SameObjectProduct(FormulaDefinitionElement element1, FormulaDefinitionElement element2) {
	...
	public String generateFormulaElement() {
		return "new SameObjectProduct(" + element1.generateFormulaElement() + "\n\t\t,"

 ...
 *
 */
public class SameObjectSubstract
		implements
	 ...
	 * 
	 * @param element1 the element to be divised (e.g. 5 in " 5 - 2 = 3")
	 * @param element2 the number to divide into (e.g. 2 in " 5 - 2 = 3")
	 */
	public SameObjectSubstract(FormulaDefinitionElement element1, FormulaDefinitionElement element2)
		 {
	...
	public String generateFormulaElement()  {
		return "new SameObjectSubstract(" + element1.generateFormulaElement() + "\n\t\t,"

 ...
 *
 */
public class LinkObjectToMasterNodeLink extends
SmartReportNodeLink {
	 ...
	 *                   object
	 */
	public LinkObjectToMasterNodeLink(SmartReportNode childnode, LinkObjectToMaster<?, ?> linkobjecttomaster) {
		super(childnode);
		this.linkobjecttomaster = linkobjecttomaster;
		if (linkobjecttomaster.getRightobjectforlink() != childnode.getRelevantObject())
			throw new RuntimeException(
					"Incompatible objects, link right object = " + linkobjecttomaster.getRightobjectforlink().getName()
	...
	protected void generateImports(SourceGenerator sg) throws IOException {
		DataObjectDefinition linkparentobject = linkobjecttomaster.getParent();
	...
	public DataObjectDefinition getLeftObject() {
		return linkobjecttomaster.getLeftobjectforlink();
	}
	...
	protected void gatherData(
		...
		String childclass = StringFormatter.formatForJavaClass(linkobjecttomaster.getRightobjectforlink().getName());
		String childattribute = StringFormatter.formatForAttribute(linkobjecttomaster.getRightobjectforlink().getName());
		String parentattribute = StringFormatter.formatForAttribute(linkobjecttomaster.getLeftobjectforlink().getName());
		String parentclass = StringFormatter.formatForJavaClass(linkobjecttomaster.getLeftobjectforlink().getName());
		String linkclass = StringFormatter.formatForJavaClass(linkobjecttomaster.getParent().getName());

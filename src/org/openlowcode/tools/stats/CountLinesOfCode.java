...
public class CountLinesOfCode {
	...
	public static void main(String args[]) {
		if (args.length!=2) {
			...
			System.err.println("	file is the file to log the results (date, gallium version, number of lines, number of comments, number of lines autogenerated, number of comments autogenerated");
			System.exit(1);
		}
		...
		try {
			...
			writer.write("Date,Gallium Version,"+lines+"Comments,Autogenerated,Comments AutoGenerated,Code Generation,All lines,All non blank lines\n");
